...
pagedf1 <- data.frame(Category = rep(category1,each=47),
                      Name = Name1[2:48],
                      Price = Price1[1:47],
...
pagedf2 <- data.frame(Category = rep(category1,each=47),
                      Name = Name2[2:48],
                      Price = Price2[1:47],
...
pagedf3 <- data.frame(Category = rep(category1,each=6),
                      Name = Name3[2:7],
                      Price = Price3[1:6],
                      Rating = Ratings3[1:6],
...
mensTshirt <- rbind(pagedf1,pagedf2,pagedf3)
mensTshirt             
# view(mensTshirt)
...
```{r}
#Mens Shorts
url1 <- "https://www.amazon.co.uk/Mens-Shorts-Free-UK-Delivery-Amazon/s?keywords=Men%27s+Shorts&rh=n%3A1731002031%2Cp_76%3A419159031&c=ts&ts_id=1731002031"
...
#2nd page
url2 <- "https://www.amazon.co.uk/Mens-Shorts-Free-UK-Delivery-Amazon/s?k=Men%27s+Shorts&i=fashion-mens-clothing&rh=n%3A1731002031%2Cp_76%3A419159031&page=2&c=ts&qid=1707409377&ts_id=1731002031&ref=sr_pg_2"
...
url3 <- "https://www.amazon.co.uk/Mens-Shorts-Free-UK-Delivery-Amazon/s?k=Men%27s+Shorts&i=fashion-mens-clothing&rh=n%3A1731002031%2Cp_76%3A419159031&page=3&c=ts&qid=1707411738&ts_id=1731002031&ref=sr_pg_3"
...
Products <- rbind(MenShorts,mensTshirt)
Products
# view(Products)
```
################################################################################
